...
const generateToken = (id) => {
  return jwt.sign({ id }, jwtConfig.JWT_SECRET, { expiresIn: jwtConfig.JWT_EXPIRES_IN });
};

// @desc Register User (Patient, Doctor, or Pharmacy)
exports.registerUser = async (req, res) => {
  try {
    const { name, email, password, role, licenseNumber, specialization, bloodGroup } = req.body;
