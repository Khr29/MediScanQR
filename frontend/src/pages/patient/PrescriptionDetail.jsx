...
import { ArrowLeft, QrCode, Pill, Calendar, User, ShieldCheck, AlertCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs bg-slate-50 p-4 rounded-xl border border-slate-100">
          <div>
            ...
            <span className="font-bold text-slate-800 flex items-center gap-1.5 mt-0.5">
              ...
              {prescription.doctor?.name ? `Dr. ${prescription.doctor.name}` : prescription.doctorName ? `Dr. ${prescription.doctorName}` : 'Authorized Physician'}
            </span>
          </div>
          <div>
