    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-8">
          <h1 className="text-2xl font-bold text-slate-900 mb-1">Doctor Verifications</h1>
          <p className="text-xs text-slate-500 mb-6">Review credentials and approve medical practitioner accounts</p>
            ...
            >
              {filtered.map((doc) => (
                <tr key={doc._id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4 text-xs text-slate-500">{new Date(doc.createdAt || Date.now()).toLocaleDateString()}</td>
