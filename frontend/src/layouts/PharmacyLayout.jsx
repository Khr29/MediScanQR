      ...
      <div className="flex flex-1">
        ...
        >
          ...
          <nav className="space-y-1" onClick={closeOnLinkClick}>
            <NavItem to="/pharmacy/dashboard" icon={LayoutDashboard} label="Dashboard" tone="brand" dark />
            <NavItem to="/pharmacy/scan" icon={ScanLine} label="Scan QR" tone="accent" dark />
            <NavItem to="/pharmacy/history" icon={History} label="History" tone="brand" dark />
            <NavItem to="/pharmacy/profile" icon={UserCircle} label="Profile" tone="brand" dark />
          </nav>
        </aside>
