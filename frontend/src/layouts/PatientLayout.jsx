...
import { LayoutDashboard, FileText, Pill, UserCircle, Bell, Menu, X, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { to: '/patient/history', icon: Pill, label: 'Medicine History' },
      ...
      <div className="flex flex-1">
        ...
        >
          ...
          <button
            ...
            className={`mt-4 hidden w-full items-center gap-2 rounded-lg border border-ink-100 py-2 text-xs font-semibold text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-700 lg:flex ${
