      ...
      <html>
        <head>
          ...
          <style>
            ...
            h2 { margin: 0 0 8px 0; color: #E9005B; }
            p { margin: 4px 0; color: #475569; font-size: 14px; }
            .badge { display: inline-block; padding: 4px 12px; background: #eefaff; color: #0885b8; border-radius: 9999px; font-weight: 600; font-size: 12px; margin-top: 12px; }
          </style>
        </head>
        <body>
          <div class="card">
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Digital QR Pass" size="small">
      ...
      <div className="flex gap-2">
        <button
          ...
          disabled={!qrCodeUrl}
          className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-accent-500 text-white text-xs font-semibold hover:bg-accent-600 disabled:opacity-50 transition-colors"
        >
